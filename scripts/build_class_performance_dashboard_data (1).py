...
def clean_sessions_df(raw_df):
    ...
    # Admin Holds count as a paid visit -- confirmed with Remy: these are
    # mainly private classes, so a held spot represents real revenue, not
    # an empty spot. Unavailable Holds (broken equipment etc.) deliberately
    # NOT included -- that's lost capacity, not a paid visit.
